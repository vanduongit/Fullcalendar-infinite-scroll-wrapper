...
function useMultiCalendarScroll(calendarRef, scrollOptions, fetchMore, firstLoad) {
    ...
    var _e = reactExports.useState(0), days = _e[0], setDays = _e[1];
    var _f = reactExports.useState(), calendarDom = _f[0], setCalendarDom = _f[1];
    var getCalendarApi = reactExports.useCallback(function getCalendarApi() {
        var current = calendarRef.current;
        return current === null || current === void 0 ? void 0 : current.getApi();
    }, [calendarRef]);
    var handleFetchMore = reactExports.useCallback(function handleFetchMore(currentStartDate, currentEndDate, distanceDays) {
    ...
    var calendarMove = reactExports.useCallback(function calendarMove(steps) {
        if (!calendarDom) {
            return;
        }
    ...
    var throttleCalendarMove = reactExports.useMemo(function () { return throttle_1(calendarMove, 1000); }, [calendarMove]);
    var scrollerClickedRef = reactExports.useRef(false);
    var navigateCalendar = reactExports.useCallback(function (event) {
    ...
    var handleMoveToDate = reactExports.useCallback(function (date) {
        var calendarApi = getCalendarApi();
    ...
    var handleMove = reactExports.useCallback(function handleMove(direction) {
        var calendarApi = getCalendarApi();
        if (calendarApi) {
...
var FullCalendarInfiniteScrollWrapper = function (_a) {
    ...
    var calendarRef = reactExports.useRef();
